    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
            <div className="flex flex-col justify-center h-full">
                ...
                <p className="text-gray-400 py-4 max-w-md">I have been programming for over 8 years. I have industrial work experience working at Pearson Canada Inc. as a web developer.  I also completed numerous personal projects in my spare time to enhance my programming knowledge. Currently, some of the technologies I like to work with include HTML, CSS, JavaScript, React and Tailwind.</p>
                <div>
